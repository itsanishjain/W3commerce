  ...
  <div>
        ...
        <div className="flex flex-wrap items-center sm:-mx-3">
          <div className="w-full md:w-1/2 md:px-3">
            <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-7 sm:pr-5 lg:pr-0 md:pb-0">
              <h1 className="text-4xl font-extrabold tracking-tight text-pink-500 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
              ...
              <div className="relative flex flex-col sm:flex-row sm:space-x-4">
                <Link href="/marketplace" passHref>
                  <a className="flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-gradient-to-r from-pink-500 to-pink-100 text-black rounded-md sm:mb-0 hover:bg-pink-700 sm:w-auto">
                    Explore Creators
                    <svg
    ...
    <section className="w-full  pt-7 pb-7 md:pt-20 md:pb-24">
      <div className="box-border flex flex-col items-center content-center px-8 mx-auto leading-6 text-black border-0 border-gray-300 border-solid md:flex-row max-w-7xl lg:px-16">
        ...
        <div className="box-border order-first w-full text-black border-solid md:w-1/2 md:pl-10 md:order-none">
          <h2 className="m-0 text-xl font-semibold leading-tight border-0 border-gray-300 lg:text-3xl md:text-2xl text-pink-400">
            Build a direct, meaningful connection with your audience
          </h2>
          <p className="pt-4 pb-8 m-0 leading-7 text-pink-100 border-0 border-gray-300 sm:pr-12 xl:pr-32 lg:text-lg">
          ...
          <ul className="p-0 m-0 leading-6 border-0 border-gray-300 space-y-2">
            <li className="box-border relative py-1 pl-0 text-left text-gray-500 border-solid flex">
              <span className="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-pink-500 rounded-full">
    ...
    <section className="w-full  pt-7 pb-7 md:pt-20 md:pb-24">
      <div className="box-border flex flex-col items-center content-center px-8 mx-auto leading-6 text-black border-0 border-gray-300 border-solid md:flex-row max-w-7xl lg:px-16">
        ...
        <div className="box-border order-first w-full text-black border-solid md:w-1/2 md:pl-10 md:order-none">
          <h2 className="m-0 text-xl font-semibold leading-tight border-0 border-pink-300 lg:text-3xl md:text-2xl text-pink-400">
            Develop a recurring income stream Stop rolling the dice of ad
            revenue and per-stream payouts.
          </h2>
          <p className="pt-4 pb-8 m-0 leading-7 border-0 border-gray-300 sm:pr-12 xl:pr-32 lg:text-lg text-pink-100">
